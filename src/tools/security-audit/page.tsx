        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="grid gap-5 lg:grid-cols-[minmax(0,1.05fr)_0.95fr]">
                <section className="space-y-4 rounded-2xl border border-zinc-800/70 bg-zinc-950/70 p-5 shadow-[0_16px_70px_-50px_rgba(0,0,0,0.85)]">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                        <button
                            ...
                            className="inline-flex items-center gap-2 rounded-lg border border-emerald-400/70 bg-emerald-500/15 px-4 py-2 text-sm font-semibold text-emerald-100 transition hover:-translate-y-0.5 hover:border-emerald-300/90 hover:bg-emerald-500/25 disabled:cursor-not-allowed disabled:opacity-50"
                        >
                            {loading ? (
                                <>
                        ...
                        <span className="text-xs uppercase tracking-[0.2em] text-slate-500">IA · Veredicto guiado</span>
                    </div>

                    {aiNote && <p className="text-xs text-amber-200">{aiNote}</p>}
                    {error && (
                    ...
                    <div className="grid gap-3 md:grid-cols-2">
                        <div className={`rounded-xl border ${SEMAFORO_STYLES[security.level].border} bg-slate-900/70 p-4`}>
                            ...
                            <details className="mt-3 text-xs text-slate-400">
                                <summary className="cursor-pointer text-slate-300">Notas rápidas</summary>
                ...
                <aside className="space-y-4">
                    <div className="rounded-2xl border border-zinc-800/70 bg-gradient-to-br from-zinc-900 via-zinc-950 to-zinc-900 p-5 shadow-[0_16px_70px_-50px_rgba(0,0,0,0.85)]">
                        <div className="flex flex-wrap items-center gap-3">
                            ...
                            <button
                                ...
                                className="ml-auto inline-flex items-center gap-2 rounded-lg border border-slate-700 bg-slate-900/60 px-3 py-2 text-xs font-semibold text-slate-200 transition hover:border-slate-500"
                            >
                    ...
                    <details className="rounded-2xl border border-zinc-800/70 bg-zinc-950/70 p-4 text-sm text-zinc-100">
                        <summary className="flex cursor-pointer items-center gap-2 text-xs uppercase tracking-wide text-slate-400">
